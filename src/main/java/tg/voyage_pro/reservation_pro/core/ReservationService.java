...
public class ReservationService {
    ...
    public List<ReservationDTO> getAll(){
        return this.rsr.findAll().stream().map( x->
                ...
                .idClient(x.getClient().getIdClient())
                .idVoyage(x.getVoyage().getIdVoyage())
                .idReservation(x.getIdReservation())
                .nomClient( x.getClient().getNomClient())
                .libelleVoyage(x.getVoyage().getLibelleVoyage())
                .mailClient(x.getClient().getMailClient())
                .dateReservation(x.getDateReservation())
                .build()
    ...
    public ReservationDTO get(Long idReservation){
        ...
        return ReservationDTO.builder()
            ...
            .libelleVoyage(r.getVoyage().getLibelleVoyage())
    ...
    public ReservationDTO update(ReservationDTO r){
        ...
        return ReservationDTO.builder()
            ...
            .libelleVoyage(res.getVoyage().getLibelleVoyage())
